...
<!-- Animated SVG Header -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=250&section=header&text=Givaro%20Ananta&fontSize=70&fontAlignY=35&animation=twinkling&fontColor=ffffff&desc=AI%20Enthusiast%20%7C%20Data%20Science%20Student&descSize=20&descAlignY=55" width="100%"/>
...
I am a **Data Science Student** and **AI Enthusiast** passionate about building intelligent, data-driven solutions and turning raw data into meaningful insights. 

- 🎓 Currently studying Data Science
- 💻 Interested in Machine Learning, Deep Learning, Natural Language Processing, and Computer Vision
- 🚀 Love building interactive web apps and dashboards to showcase data science models
...
- **Data Science & AI:** Streamlit, YOLOv8, OpenCV, Pandas, NumPy, Scikit-Learn
- **Web Development:** React, Next.js, Tailwind CSS, FastAPI, Node.js
- **Tools & DevOps:** Git, GitHub Actions, Docker, Vercel, VS Code
